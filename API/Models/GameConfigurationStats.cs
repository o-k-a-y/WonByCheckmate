...
namespace API.Models
{
    ...
    public class GameConfigurationStats
    {
        ...
        public GameConfigurationStats(HashSet<string> configuations) {
            stats = new Dictionary<string, Dictionary<GameResultType, int>>();
            foreach (string config in configuations) {
        ...
        private Dictionary<GameResultType, int> GameConfigurationDictionary() {
            ...
            gameStats[GameResultType.WonOnTime] = 0;
            ...
            gameStats[GameResultType.DrawByRepitition] = 0;
            ...
            gameStats[GameResultType.LostOnTime] = 0;
